...
module.exports = {
	...
	execute: async (interaction) => {
		...
		if (queue == null || !queue.connection) {
			await interaction.editReply("I have to be connected to be disconnected, Praetor! <:neroSmug:784115410831802378>");
			return;
		}
        ...
        await interaction.editReply("See you next time, Praetor! <:neroSleep:784437008990470265>");
	},
}